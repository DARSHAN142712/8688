...
public class Amazon {
    ...
    static String Admin_Id = "dc";
    static String Admin_Password = "8688";
    static int Admin_attempt = 5;
    static int Merchant_attempt = 4;
    static int User_Attempt = 6;
    static int M_Id = 6;
    static int U_Id = 7;
    static int Current_Merchant = 3;
    static int Current_User = 2;

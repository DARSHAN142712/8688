...
public class Main{
    ...
    static String[] per1 = {"8688" , "same" , "0" , "15000","Unblock"};
    static String[] per2 = {"8688" , "not" , "0" , "15000","Unblock"};
    static String[] per3 = {"8688" , "not" , "0" , "15000","Unblock"};
    static String[] per4 = {"8688" , "same" , "0" , "15000","Unblock"};
    ...
    static int checkAdmin(){
        ...
        pwd = s.nextLine();
        if((adm.equals("dcdc")) && (pwd.equals("dcdc14"))){
            return 1;
        }
        else
        return 0;

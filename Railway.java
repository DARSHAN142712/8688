...
class Admin{
    ...
    static void admlog(){
        ...
        String usernamedc = sc.nextLine();
        System.out.print("Enter the Admin Password : ");
        String pwd = sc.nextLine(); 
        if((usernamedc.equals("86")) && (pwd.equals("88"))){
            admActions(usernamedc);
        }
        else{
    ...
    //--------------------------------------------------------------------------------------Admin Actions
    static void admActions(String usernamedc){
        main.flusher();
        Scanner sc = new Scanner(System.in);
        ...
        if(adcho.equals("1")){
            createTrain(usernamedc);//----------------------------------------------------------Complete
        }
        else if(adcho.equals("2")){
            viewTrains(usernamdc);//-----------------------------------------------------------Complete
        }
            ...
            int a = sc.nextInt();
            viewBookings(usernamedc,a);//--------------------------------------------------------Complete
        }
    ...
    //--------------------------------------------------------------------------------------Creating Train
    static void createTrain(String usernamedc){
        main.flusher();
        Scanner sc = new Scanner(System.in);
    ...
    static void viewTrains(String usernamedc){
        if(trainName.size()<=1){
        ...
        List<String> lis = new ArrayList<String>();
        main.flusher();
        System.out.println("---------*Welcome " +usernamedc +"*---------");
        for(int i=1 ; i<trainName.size() ; i++){
            System.out.println(i +". " +trainName.get(i));
        }
    ...
    //-----------------------------------------------------------------------------------Going Back
    static void goBack(String usernamedc){
        if(username00.equals("11")){
            admActions(usernamedc);
        }
        else{
            user.usrActions(user.usrHp.get(usernamedc),usernamedc);
        }
    }
    //------------------------------------------------------------------------------------View Booked Trains
...
class User{
    ...
    //----------------------------------------------------------------------------------User Actions
    static void usrActions(int a , String usernamedc){
        main.flusher();
        Scanner sc = new Scanner(System.in);
        System.out.print("-------------------*Welcome User*----------------" +"\n" +"1. See Trains & Routes" +"\n" +"2. Seat Booking" 
        ...
        String adcho = sc.nextLine();
        if(adcho.equals("1")){
            admin.viewTrains(usernamedc);//--------------------------------------------------------Complete
        }
        else if(adcho.equals("2")){
            int[] arr=viewTrain(a,usernamedc);
            bookTrains(a,usernamedc,arr);//--------------------------------------------------------Complete
            System.out.print("Enter to Exit");
            main.enterNeeded();
            usrActions(a,usernamedc);
        }
        else if(adcho.equals("3")){
            cancelTickets(a,usernamedc);//--------------------------------------------------------Complete
        }
        else if(adcho.equals("4")){
            viewBookings(a,usernamedc);//--------------------------------------------------------Complete
            main.enterNeeded();
            usrActions(a,usernamedc);
        }
    ...
    static int[] viewTrain(int a,String usernamedc){
        int[] arr = new int[3];
   ...
   //----------------------------------------------------------------------------------Viewing Each person Bookings 
    static int viewBookings(int a , String usernamedc){
